...
<?php 
	...
	if (isset($_POST['date'])){
		$showForrm='<div class="alert alert-danger alert-dismissible fade show" role="alert">
				...
				<div class="col-md-12 col-md-push-1">
					<div class="panel panel-default" style="padding: 20px;">
						<div class="panel-body">
							...
							<div class="test-success text-center" id="data" style="margin: top 20px;"><?php if(isset($showForrm)) echo $showForrm; ?><!--display message --></div>
							...
							<button style="margin-top: 20px;" name="date" id="save_the_life" type="submit" class="btn btn-lg btn-danger center-aligned ">Save The Life</button>
										...
										<span></span><span class = "name">Congratulation!</span>
